    ...
    return (
        <div className='main-container'>
            ...
            <div className='service-container'>
                <div className='fabric-printing'>
                    <img src="https://itnh.com/wp-content/uploads/2018/07/surecolor_f7200_angle_with_print.png" alt='' />
                    <h4>Digital Fabric Printing</h4>
                ...
                <div className='deying-fabric'>
                    <img src="https://botanicalcolors.com/wp-content/uploads/2018/06/Saxon-Blue-Fabric-and-Yarn.png" alt='' />
                    <h4>Febric Deying</h4>
                ...
                <div className='sweater'>
                    <img src="https://m.media-amazon.com/images/I/51OCZJvEjxL.jpg" alt='' />
                    <h4>Sweater</h4>
